...
namespace System
{
    public struct TweakColor
    {
        ...
        public const string DarkRed = "~dr~";
        public const string DarkMagenta = "~dm~";
        public const string DarkYellow = "~dy~";
        public const string DarkGray = "~dge~";
        public const string Gray = "~ge~";
